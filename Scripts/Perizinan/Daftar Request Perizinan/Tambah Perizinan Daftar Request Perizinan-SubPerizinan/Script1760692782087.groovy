...
WebUI.click(findTestObject('Perizinan/Daftar Request Perizinan 2/Add Perizinan/Page_One Click Permitting/click_sub-perizinan'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Perizinan/Daftar Request Perizinan 2/Add Perizinan/Page_One Click Permitting/b_Per-utama-Sub-Perizinan'), 
    FailureHandling.STOP_ON_FAILURE)
