...
WebUI.click(findTestObject('Master Data/KBLI/sorting/Page_One Click Permiting/th_sorting-kbli-name'))

WebUI.click(findTestObject('Master Data/KBLI/sorting/Page_One Click Permiting/th_sorting-kbli-name'))

WebUI.click(findTestObject('Master Data/KBLI/sorting/Page_One Click Permiting/th_Status'))
