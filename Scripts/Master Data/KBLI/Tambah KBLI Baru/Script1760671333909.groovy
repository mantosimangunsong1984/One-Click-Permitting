...
WebUI.setText(findTestObject('Master Data/Category Permit/Page_One Click Permiting/Page_One Click Permiting/input_KBLI Name_EDIT'), 
    'Test Doc KBLI 88888')

WebUI.setText(findTestObject('Master Data/KBLI/Page_One Click Permitting/input_Nama KBLI (ENG)_kblinameeng'), 'Test Doc KBLI 88888')

WebUI.click(findTestObject('Master Data/KBLI/Page_One Click Permitting/button_Simpan'), FailureHandling.STOP_ON_FAILURE)
