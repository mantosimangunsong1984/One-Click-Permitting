...
WebUI.setText(findTestObject('Master Data/Type Permit/Page_One Click Permiting/input_TypePermit-Edit'), 'Testing Type Permit - 2')
...
WebUI.setText(findTestObject('Master Data/Type Permit/Page_One Click Permiting/input_select-category-permit'), '05100')
